...
import { createMulberry32, generateResourceTilesForPlanet, selectPlanetsForResources, } from './star-map-resources.util';
const makePlanet = (id, size = 'medium') => ({
    id,
    index: id,
    name: `Planet ${id}`,
    factionId: 'player',
