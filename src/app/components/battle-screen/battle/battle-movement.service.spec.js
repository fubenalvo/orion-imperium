...
describe('BattleMovementService', () => {
    ...
    it('sets a vw target and moves the stack toward it over time', async () => {
        ...
        const expectedTarget = stackCenterVw({ side: stack.side, size: stack.size, col: targetCol, row: targetRow });
