 ...
 */
let FleetAssemblyService = class FleetAssemblyService {
    shipService;
    shipStockService;
    spaceportService;
    movementService;
    constructor(shipService, shipStockService, spaceportService, movementService) {
        this.shipService = shipService;
        this.shipStockService = shipStockService;
        this.spaceportService = spaceportService;
        this.movementService = movementService;
    }
    createFleet(data, starSystems, request) {
    ...
    reinforceFleet(data, starSystems, request) {
    ...
    disbandFleet(data, factionId, fleetId) {
    ...
    checkStock(data, factionId, composition) {
    ...
    stockEntryToFleetShip(entry) {
        const shipType = this.shipService.getShipType(entry.type);
        return {
            id: entry.id,
            type: entry.type,
            name: entry.name,
...
FleetAssemblyService = __decorate([
    Injectable({ providedIn: 'root' })
], FleetAssemblyService);
export { FleetAssemblyService };
