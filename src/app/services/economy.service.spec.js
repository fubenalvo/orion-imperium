...
describe('EconomyService — habitability & workforce', () => {
    ...
    const makePlanet = (id, type, buildings = [], overrides = {}) => ({
        id,
        index: id,
        name: `Planet ${id}`,
        factionId: 'player',
    ...
    describe('3. ice planet has negative morale drift', () => {
        ...
        it('is more negative than desert', () => {
            expect(economy.getMoraleDriftPerSecond(makePlanet(1, 'ice'))).toBeLessThan(economy.getMoraleDriftPerSecond(makePlanet(2, 'desert')));
        });
    });
    ...
    describe('8. morale is frozen while paused (deltaTime 0)', () => {
        ...
        const wrap = (planet) => {
            ...
            return { factions: [makeFaction()], systems: [system], fleets: [] };
        };
    ...
    describe('9. morale tick scales with game time (2x => 2x drift)', () => {
        ...
        it('desert morale drift (-0.05) is part of the per-second delta', () => {
            ...
            const cloneAt = (delta) => ({ ...base, satisfaction: 90 });
            const f1 = cloneAt(1);
    ...
    describe('10. population growth', () => {
        ...
        const wrap = (planet, factionId = 'player') => {
            const system = {
                id: 'sys1',
                name: 'System 1',
                x: 0,
            ...
            const faction = { ...makeFaction(), id: factionId };
